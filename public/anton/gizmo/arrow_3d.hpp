...
namespace anton::gizmo {
    ...
    [[nodiscard]] math::Mat4 calculate_transform(math::Mat4 const& world_transform, f32 fixed_scale_factor);
    ...
    // gizmo_transform - a transform to the world space generated by calculate_transform.
    //
    // Returns:

...
namespace anton::gizmo {
    ...
    u32 generate_arrow_3d_geometry(Arrow_3D_Style const style, u32 const vertex_count, f32* vertices);
    ...
    std::optional<f32> intersect_arrow_3d(Ray, Arrow_3D, f32 const* world_transform, f32 const* view_projection_matrix, u32 viewport_width,
                                          u32 viewport_height);
} // namespace anton::gizmo

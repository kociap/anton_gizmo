#ifndef ANTON_MATH_MARTIX3_HPP_INCLUDE
#define ANTON_MATH_MARTIX3_HPP_INCLUDE
...
namespace anton {
    ...
    public:
        ...
        Matrix3();
        explicit Matrix3(float const* const ptr): rows{Vector3(ptr), Vector3(ptr + 3), Vector3(ptr + 6)} {}
...
#endif // !ANTON_MATH_MARTIX3_HPP_INCLUDE
